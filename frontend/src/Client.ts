...
// import * as net from 'net'; // Import the net module for networking capabilities
// import * as readline from 'readline'; // Import the readline module for reading input from the terminal
// import { COMMANDS, CONSTRAINTS, INPUTS, MESSAGES, ERROR_CODES } from 'common/constants';
...
//         this.client.on('data', (data: Buffer) => {
//             this.commandHandler.handleServerData(data);
//         });
//         this.client.on('close', () => {
...
//             this.client.connect(this.address, () => {
//                 Utils.print('Connected to the Unix socket...');
//                 this.showWelcomeMessage();
//             });
//         } else {
//             const [ip, port] = this.address.split(':');
//             this.client.connect(parseInt(port), ip, () => {
//                 Utils.print('Connected to the server...');
//                 this.showWelcomeMessage();
//             });
//         }
//     }
...
//         // 'ECONNREFUSED' - 'local', 'ENOENT' - network
//         if (error.message.includes('ECONNREFUSED') || error.message.includes('ENOENT')) {
//             Utils.print('Cannot connect to server. Please make sure the server is running and try again.\n');
//             this.rlInterface.question('Do you want to try reconnecting? (Y/N): ', (answer: string) => {
//                 if (answer.toUpperCase() === 'Y') {
//                     this.client.destroy(); // Destroy the client socket
//                     this.connectToServer(); // Try to connect again
//                 } else {
//                     Utils.print('Program has been terminated. You can restart it using "npm start".\n');
//                     process.exit(1);
//                 }
//             });
//         } else {
//             Utils.print('An unknown error occurred.');
//             process.exit(1);
//         }
//     }
// }
